...
module Kramdown2
  ...
  module Converter
    ...
    # Converts a Kramdown2::Document to a manpage in groff format. See man(7), groff_man(7) and
    ...
    class Man < Base
      ...
      def convert_root(el, opts)
        @title_done = false
        opts[:result] = +".\\\" generated by kramdown2\n"
        inner(el, opts)
        opts[:result]
      end
      ...
      def convert_smart_quote(el, opts)
        opts[:result] << unicode_char(::Kramdown2::Utils::Entities.entity(el.value.to_s).code_point)
      end
