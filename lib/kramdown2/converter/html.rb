...
module Kramdown2
  ...
  module Converter
    ...
    # Converts a Kramdown2::Document to HTML.
    #
    ...
    class Html < Base
      ...
      include ::Kramdown2::Utils::Html
      include ::Kramdown2::Parser::Html::Constants

      # The amount of indentation used when nesting HTML tags.
      attr_accessor :indent

      # Initialize the HTML converter with the given Kramdown2 document +doc+.
      ...
      ENTITY_NBSP = ::Kramdown2::Utils::Entities.entity('nbsp') # :nodoc:
      ...
      TYPOGRAPHIC_SYMS = {
        mdash: [::Kramdown2::Utils::Entities.entity('mdash')],
        ndash: [::Kramdown2::Utils::Entities.entity('ndash')],
        hellip: [::Kramdown2::Utils::Entities.entity('hellip')],
        laquo_space: [::Kramdown2::Utils::Entities.entity('laquo'),
                      ::Kramdown2::Utils::Entities.entity('nbsp')],
        raquo_space: [::Kramdown2::Utils::Entities.entity('nbsp'),
                      ::Kramdown2::Utils::Entities.entity('raquo')],
        laquo: [::Kramdown2::Utils::Entities.entity('laquo')],
        raquo: [::Kramdown2::Utils::Entities.entity('raquo')],
      } # :nodoc:
