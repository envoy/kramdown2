...
module Kramdown2
  ...
  #
  # kramdown2 only uses this one class for representing all available elements in an element tree
  # (paragraphs, headers, emphasis, ...). The type of element can be set via the #type accessor.
  #
  # The root of a kramdown2 element tree has to be an element of type :root. It needs to have certain
  ...
  #
  # Represents the root of a kramdown2 document.
  #
  ...
  #             parts of the kramdown2 document.
  #
  ...
  #
  # The +value+ field has to contain an instance of Kramdown2::Utils::Entities::Entity. The option
  ...
  class Element
    ...
    # syntactic sugar to simplify calls such as +Kramdown2::Element.category(el) == :block+ with
    # +el.block?+.
    #
    ...
    # syntactic sugar to simplify calls such as +Kramdown2::Element.category(el) == :span+ with
    # +el.span?+.
    #
    # Returns boolean true or false.
    def span?
