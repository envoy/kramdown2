...
module Kramdown2
  ...
  module Parser
    ...
    #
    # This parser is based on the kramdown2 parser and removes the parser methods for the additional
    # non-Markdown features. However, since some things are handled differently by the kramdown2
    ...
    class Markdown < Kramdown2

      # Array with all the parsing methods that should be removed from the standard kramdown2 parser.
