  ...
  module Parser
    ...
    class Html < Base
      ...
      module Constants
        ...
        # be expressed using kramdown2 syntax: colgroup table tbody thead tfoot tr ul ol
      ...
      class ElementConverter
        ...
        include Constants
        include ::Kramdown2::Utils::Entities
        ...
        def process_text(raw, preserve = false)
          ...
          src = Kramdown2::Utils::StringScanner.new(raw)
          result = []
          until src.eos?
            if (tmp = src.scan_until(/(?=#{HTML_ENTITY_RE})/o))
              ...
              result << if %w[lsquo rsquo ldquo rdquo].include?(val)
                          ...
                          begin
                            ...
                            Element.new(:entity, ::Kramdown2::Utils::Entities.entity('amp'))
                          end
                        end
            else
      ...
      def parse
        @stack, @tree = [], @root
        @src = Kramdown2::Utils::StringScanner.new(adapt_source(source))
