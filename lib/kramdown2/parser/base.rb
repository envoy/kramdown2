...
module Kramdown2
  ...
  module Parser
    ...
    # used by all parsers, especially by those using StringScanner(Kramdown2) for parsing.
    #
    ...
    # in the Kramdown2::Parser module -- the latter is needed so that the auto-detection of the new
    ...
    class Base
      ...
      def initialize(source, options)
        @source = source
        @options = Kramdown2::Options.merge(options)
