...
module Kramdown2
  ...
  module Parser
    ...
    # Used for parsing a document in kramdown2 format.
    #
    ...
    #
    #   require 'kramdown2/parser/kramdown2'
    #
    #   class Kramdown2::Parser::ERBKramdown < Kramdown2::Parser::Kramdown2
    #
    ...
    #
    #   require 'kramdown2/document'
    #   # require the file with the above parser class
    #
    #   Kramdown2::Document.new(input_text, :input => 'ERBKramdown').to_html
    #
    class Kramdown2 < Base

      include ::Kramdown2

      # Create a new Kramdown2 parser object with the given +options+.
      def initialize(source, options)
        super
      ...
      def configure_parser
        ...
        (@block_parsers + @span_parsers).each do |name|
          if self.class.has_parser?(name)
            ...
            raise Kramdown2::Error, "Unknown parser: #{name}"
          end
        end
      ...
      def parse_blocks(el, text = nil)
        ...
        @src = (text.nil? ? @src : ::Kramdown2::Utils::StringScanner.new(text, el.options[:location]))
      ...
      def update_tree(element)
        ...
        element.children.map! do |child|
          if child.type == :raw_text
            last_blank = nil
            reset_env(src: ::Kramdown2::Utils::StringScanner.new(child.value, element.options[:location]),
                      text_type: :text)
            parse_spans(child)
            child.children
      ...
      require 'kramdown2/parser/kramdown2/paragraph'
      require 'kramdown2/parser/kramdown2/header'
      require 'kramdown2/parser/kramdown2/blockquote'
      require 'kramdown2/parser/kramdown2/table'
      require 'kramdown2/parser/kramdown2/codeblock'
      require 'kramdown2/parser/kramdown2/horizontal_rule'
      require 'kramdown2/parser/kramdown2/list'
      require 'kramdown2/parser/kramdown2/link'
      require 'kramdown2/parser/kramdown2/extensions'
      require 'kramdown2/parser/kramdown2/footnote'
      require 'kramdown2/parser/kramdown2/html'
      require 'kramdown2/parser/kramdown2/escaped_chars'
      require 'kramdown2/parser/kramdown2/html_entity'
      require 'kramdown2/parser/kramdown2/line_break'
      require 'kramdown2/parser/kramdown2/typographic_symbol'
      require 'kramdown2/parser/kramdown2/autolink'
      require 'kramdown2/parser/kramdown2/codespan'
      require 'kramdown2/parser/kramdown2/emphasis'
      require 'kramdown2/parser/kramdown2/smart_quotes'
      require 'kramdown2/parser/kramdown2/math'
      require 'kramdown2/parser/kramdown2/abbreviation'
